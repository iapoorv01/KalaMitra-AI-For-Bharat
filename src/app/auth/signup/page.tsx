    ...
    <div className="min-h-screen bg-gradient-to-br from-[var(--bg-1)] via-[var(--bg-2)] to-[var(--bg-3)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="hidden lg:block space-y-8">
          <div className="space-y-6">
            <div className="flex items-center space-x-3">
              <div className="w-16 h-16 bg-gradient-to-br from-[var(--saffron)] to-[var(--maroon)] rounded-2xl flex items-center justify-center shadow-lg">
        ...
        <div className="w-full max-w-md mx-auto">
          <div className="card-glass p-8 space-y-8">
            ...
            <div className="text-center space-y-4">
              <div className="w-16 h-16 bg-gradient-to-br from-[var(--saffron)] to-[var(--maroon)] rounded-2xl flex items-center justify-center mx-auto shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    >
                      <div className={`w-10 h-10 mx-auto mb-2 rounded-lg flex items-center justify-center transition-all duration-200 ${
                        role === 'buyer' 
                        ...
                        <ShoppingBag className={`w-5 h-5 transition-colors duration-200 ${
                          role === 'buyer' ? 'text-white' : 'text-[var(--text-muted)] group-hover:text-white'
                        }`} />
                      </div>
                    ...
                    >
                      <div className={`w-10 h-10 mx-auto mb-2 rounded-lg flex items-center justify-center transition-all duration-200 ${
                        ...
                        <Palette className={`w-5 h-5 transition-colors duration-200 ${
                          role === 'seller' ? 'text-white' : 'text-[var(--text-muted)] group-hover:text-white'
                        }`} />
                      </div>
      ...
      {showRoleModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="card-glass p-8 max-w-md w-full space-y-6">
