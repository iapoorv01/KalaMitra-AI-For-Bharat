      ...
      <div className="container-custom max-w-4xl mx-auto py-12">
        <div className="bg-[var(--bg-2)]/90 backdrop-blur-sm rounded-3xl shadow-soft border border-[var(--heritage-gold)]/20 p-8 md:p-12 space-y-6">
          ...
          <div className="prose prose-lg text-[var(--muted)] leading-relaxed max-w-none">
            <p>KalaMitra may use basic cookies or analytics tools to improve platform performance and user experience. These cookies do not collect sensitive personal data and are only used for essential site functionality and analytics.</p>
            <p>By using this website, you consent to the use of such cookies. You can control or delete cookies through your browser settings, but some features of the site may not function properly if cookies are disabled.</p>
            <p>KalaMitra does not use cookies for advertising or third-party marketing purposes.</p>
          </div>

          <div className="bg-[var(--bg-1)] p-6 rounded-2xl mt-8 border border-[var(--heritage-gold)]/10">
            <h3 className="text-lg font-bold text-[var(--heritage-brown)] mb-2">Questions?</h3>
            <p className="text-[var(--muted)]">
              Contact us at <a href="mailto:talkto.kalamitra@gmail.com" className="text-[var(--heritage-red)] font-medium hover:underline">talkto.kalamitra@gmail.com</a>
            </p>
          </div>
        </div>
      </div>
